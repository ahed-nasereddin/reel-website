            ...
            >
                ...
                <div class="space-y-4">
                    ...
                    <div
                        ...
                        :key="index"
                        class="relative border md:border-none rounded-md p-4 space-y-3 md:space-y-0 md:flex md:items-center md:gap-4"
                    >
                        <!-- Delete Button (top-right on mobile, inline on desktop) -->
                        <button
                            type="button"
                            @click="removeEquipment(index)"
                            class="absolute top-1 bg-red-100 rounded-full w-6 h-6 right-1 text-red-500 hover:text-red-700 md:static md:ml-2"
                        >
                            &times;
                        </button>
                        ...
                        <div
                            class="flex flex-col sm:flex-row gap-3 flex-1 w-full"
                        >
                            <input
                                v-model="item.count"
                                type="number"
                                ...
                                min="1"
                                class="border rounded-md p-2 sm:w-24"
                                required
                            />
                            <input
                                v-model="item.note"
